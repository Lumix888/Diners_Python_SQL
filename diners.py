# -*- coding: utf-8 -*-
"""
Homework n2, made by Luca Mizzi, 201843IVSB, for the Advanced Python course.
"""
...
def opendb():
    """open SQLite database 'diners.db', if the database does not exist, then it will be created and finally\
...
def create_records_canteen():
    ...
    conn.execute("INSERT INTO CANTEEN ('ID', PROVIDER_ID,`NAME`,`LOCATION`,TIME_OPEN,TIME_CLOSED) \
        VALUES (1, 1, 'bitStop KOHVIK', 'IT College, Raja 4c', 9.30, 16.00)")
...
def select_rahva_toit():
    """
    fetch and display records of canteen namess from the CANTEEN table join with the PROVVIDER table,
